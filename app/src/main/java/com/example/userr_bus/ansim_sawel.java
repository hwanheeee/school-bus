...
public class AnsimSawelActivity extends AppCompatActivity {

    private static final String TAG = "AnsimSawelActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ansim_sawel);
    ...
    private void setupTimeSpinner() {
        String[] itemTime = {"시간을 선택하세요", "16:00", "16:15", "16:30", "16:40", "16:50", "17:00", "17:15", "17:30"};
    ...
    private void setupPlaceSpinner() {
        String[] itemPlace = {"장소를 선택하세요", "A2(건너편)", "안심역", "사월역"};
    ...
    private void handleReservation() {
        ...
        reservationData.put("route", "학교->안심역->사월역");
