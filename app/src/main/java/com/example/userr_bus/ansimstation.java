...
public class AnsimStationActivity extends AppCompatActivity {

    private static final String TAG = "AnsimStationActivity";
    ...
    private void setupTimeSpinner() {
        String[] itemTime = {"시간을 선택하세요", "08:10", "08:20", "08:25", "08:30", "08:40",
                "08:50", "09:00", "09:30", "09:50", "10:10", "10:20", "10:30", "12:20"};

        List<String> availableTimes = getAvailableTimes(itemTime);

        ArrayAdapter<String> adapterTime = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, availableTimes);
    ...
    private void setupPlaceSpinner() {
        String[] itemPlace = {"장소를 선택하세요", "안심역(3번출구)", "정문", "B1", "C7", "C13", "D6", "A2(건너편)"};

        ArrayAdapter<String> adapterPlace = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, itemPlace);
    ...
    private void handleReservation() {
        ...
        reservationData.put("route", "안심역 출발");
        ...
        firestore.collection("Reservation").add(reservationData)
